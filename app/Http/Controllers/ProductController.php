...
class ProductController extends Controller
{
    ...
    public function index()
    {
        $products = Auth::user()
            ...
            ->when(in_array(request()->query('sort_by'), ['name', 'price', 'weight', '-name', '-price', '-weight']), function ($query) {
    ...
    public function bulkUpdate(BulkUpdateProductRequest $request)
    {
        ...
        return redirect()->route('products.index')->with('message', 'Products has been updated successfully!');;
    }
    ...
    public function bulkDestroy(string $ids)
    {
        ...
        return redirect()
            ...
            ->with('message', 'The selected products were deleted successfully!');
    }
}
